...
void event_handler_wifi(lv_event_t* e) {
...
void event_handler_connect_wifi_win(lv_event_t* e) {
  lv_obj_t* obj = lv_event_get_target(e);
...
void ta_password_event_cb(lv_event_t* e) {
  lv_event_code_t code = lv_event_get_code(e);
...
void tft_lv_initialization() {
  ...
  lv_color_t buf1[(LV_HOR_RES_MAX * LV_VER_RES_MAX) / 10];  // Declare a buffer for 1/10 screen siz
