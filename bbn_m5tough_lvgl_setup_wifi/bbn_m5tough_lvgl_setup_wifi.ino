...
void wifi_connected() {
  ...
  lv_obj_center(label);
  lv_obj_add_event_cb(btn_cfg, btnRestWiFiSettings_event, LV_EVENT_LONG_PRESSED, NULL);
  ...
  lv_obj_add_event_cb(btn_reboot, btnReboot_event, LV_EVENT_LONG_PRESSED, NULL);
}
