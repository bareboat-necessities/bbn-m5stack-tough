...
extern "C" {
  ...
  void lv_dev_status_display(lv_obj_t *parent) {
    ...
    lv_label_set_text(pyp_status_label, (String("PyPilot:              ") + preferences.getString(PYP_TCP_HOST_PREF) + String(":") + String(preferences.getInt(PYP_TCP_PORT_PREF))).c_str());

    signalk_status_label = lv_label_create(parent);
    lv_obj_align(signalk_status_label, LV_ALIGN_TOP_LEFT, 20, 60);
    lv_label_set_text(signalk_status_label, (String("SignalK:             ") + preferences.getString(SK_TCP_HOST_PREF) + String(":") + String(preferences.getInt(SK_TCP_PORT_PREF))).c_str());

    nmea0183_status_label = lv_label_create(parent);
    lv_obj_align(nmea0183_status_label, LV_ALIGN_TOP_LEFT, 20, 90);
    lv_label_set_text(nmea0183_status_label, (String("NMEA 0183:       ") + preferences.getString(NMEA0183_TCP_HOST_PREF) + String(":") + String(preferences.getInt(NMEA0183_TCP_PORT_PREF))).c_str());
  }
