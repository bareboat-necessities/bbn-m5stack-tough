 ...
 */
  void lv_tanks_display(lv_obj_t *parent) {
    lv_obj_t *bar_w1 = lv_bar_create(parent);
    ...
    lv_obj_t *bar_w2 = lv_bar_create(parent);
    ...
    lv_obj_t *bar_bw1 = lv_bar_create(parent);
    ...
    lv_obj_t *bar_bw2 = lv_bar_create(parent);
    ...
    lv_obj_t *bar_f1 = lv_bar_create(parent);
    ...
    lv_obj_t *bar_f2 = lv_bar_create(parent);
    ...
    lv_obj_t *bar_g1 = lv_bar_create(parent);
    ...
    lv_obj_t *bar_g2 = lv_bar_create(parent);
