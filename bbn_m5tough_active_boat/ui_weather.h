...
extern "C" {
  ...
  */
  ...
  static void lv_weather_display(lv_obj_t *parent) {
    ...
    lv_label_set_text(main_label, "SUN  #0080ff " LV_SYMBOL_IMAGE " #");
...
#endif
    lv_label_set_text(weather_daylight_label, "Day Duration:   ---");
...
#endif
    lv_label_set_text(weather_twilight_label, "Twilight Duration:   ---");
